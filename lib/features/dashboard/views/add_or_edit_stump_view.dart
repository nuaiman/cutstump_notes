    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          //     : SizedBox(
          //         height:
          //             ref.watch(adProvider).bannerAd!.size.height.toDouble(),
          //         width: ref.watch(adProvider).bannerAd!.size.width.toDouble(),
          //         child: AdWidget(ad: ref.watch(adProvider).bannerAd!),
          //       ),
