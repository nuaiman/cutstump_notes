                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              const Text('Stumps'),
                              Text(getTotalStumpCount(activeProjects)
                                  .toString()),
                              Text(getTotalStumpCount(completeProjects)
                                  .toString()),
                              Text(getTotalStumpCount(cancelledProjects)
                                  .toString()),
                            ],
                          ),
                          Column(
                  ...
                  Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        ListTile(
                          title: const Text(
                              'Hight limit before percentage increase'),
                          trailing: SizedBox(
                            width: 90,
                            child: Row(
                              children: [
                        ...
                        ListTile(
                          title: const Text(
                              'Percentage increase beyond hight limit'),
                          trailing: SizedBox(
                            width: 90,
                            child: Row(
                              children: [
